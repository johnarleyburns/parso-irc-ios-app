...
/// Raw IRC terminal for developer debugging.
/// Accessible from Settings → Debug Terminal.
/// The original SimpleConnectView lives on at ParsoIRC/App/SimpleConnectView.swift
/// as the legacy entry point; this copy is renamed for use inside Settings.
