...
struct ChannelBrowserSheet: View {
    ...
    private static let popularChannels: [String: [String]] = [
        ...
        "irc.2600.net":          ["#2600", "#hacking", "#phreaking", "#security", "#chat", "#tech", "#radio", "#dc", "#phreak", "#hardware"],
        "irc.tilde.chat":        ["#meta", "#linux", "#chat", "#music", "#games", "#tildetown", "#bbs", "#net", "#oldschool", "#foss"],
        "irc.freenode.net":      ["#linux", "#python", "#debian", "#ubuntu", "#help", "#freenode", "#chat", "#gentoo", "#arch", "#foss"],
        "irc.geekshed.net":      ["#jupiterbroadcasting", "#chat", "#linux", "#tech", "#games", "#foss", "#random", "#security", "#geek", "#help"],
        "irc.gamesurge.net":     ["#help", "#chat", "#games", "#starcraft", "#warcraft", "#diablo", "#fps", "#mmorpg", "#random", "#tech"],
        "irc.irchighway.net":    ["#ebooks", "#chat", "#help", "#books", "#comics", "#audiobooks", "#random", "#games", "#movies", "#music"],
        "irc.chatjunkies.org":   ["#chat", "#random", "#music", "#games", "#movies", "#help", "#tech", "#offtopic", "#lounge", "#support"],
        "irc.allnetwork.org":    ["#allnetwork", "#chat", "#games", "#help", "#music", "#movies", "#linux", "#windows", "#random", "#offtopic"],
        "irc.p2p-irc.net":       ["#torrent", "#p2p", "#chat", "#help", "#movies", "#music", "#games", "#tech", "#random", "#support"],
        "irc.sorcery.net":       ["#sorcerynet", "#chat", "#games", "#rpg", "#random", "#linux", "#help", "#music", "#movies", "#offtopic"],
        "irc.ircam.fr":          ["#music", "#audio", "#dsp", "#supercollider", "#maxmsp", "#puredata", "#composition", "#research", "#help", "#chat"],
        "irc.digitalized.tv":    ["#chat", "#tech", "#games", "#random", "#music", "#movies", "#linux", "#help", "#offtopic", "#support"],
        "pirc.at":               ["#pirc", "#chat", "#linux", "#tech", "#random", "#help", "#games", "#security", "#privacy", "#foss"],
        "irc.anonops.com":       ["#anonops", "#chat", "#security", "#privacy", "#help", "#tech", "#random", "#offtopic", "#news", "#politics"],
        "irc.austnet.org":       ["#chat", "#australia", "#sydney", "#melbourne", "#help", "#tech", "#games", "#random", "#music", "#movies"],
    ]
